...
var inputFilePath = 'yamagata-input.csv';
var outputFilePath = 'yamagata.csv';
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                address = "\u5C71\u5F62\u770C".concat(facility.所在地);
            ...
            case 6:
                _b.sent();
                console.log('yamagata.csv has been written successfully.');
                return [2 /*return*/];
        }
    });
}); });
// npx tsc yamagata.ts && node yamagata.js | tee yamagata.log
