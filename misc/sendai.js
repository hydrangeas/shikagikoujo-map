...
var inputFilePath = 'sendai-input.csv';
var outputFilePath = 'sendai.csv';
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                address = "\u5BAE\u57CE\u770C".concat(facility.所在地);
            ...
            case 6:
                _b.sent();
                console.log('sendai.csv has been written successfully.');
                return [2 /*return*/];
        }
    });
}); });
// npx tsc sendai.ts && node sendai.js | tee sendai.log
