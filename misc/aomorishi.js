...
var inputFilePath = 'aomorishi-input.csv';
var outputFilePath = 'aomorishi.csv';
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                address = "\u9752\u68EE\u770C\u9752\u68EE\u5E02".concat(facility.所在地);
            ...
            case 3:
                ...
                for (i = 1; i < data.results.length; i++) {
                    console.log("0 ".concat(facility.施設名称, " (").concat(address, "), ").concat(location_1.lat, ", ").concat(location_1.lng, ",").concat(data.results[0].geometry.location_type));
                    result = data.results[i];
                    console.log("".concat(i, " ").concat(facility.施設名称, " (").concat(address, "), ").concat(result.geometry.location.lat, ", ").concat(result.geometry.location.lng, ", ").concat(result.geometry.location_type));
            ...
            case 6:
                _b.sent();
                console.log('aomorishi.csv has been written successfully.');
                return [2 /*return*/];
        }
    });
}); });
// npx tsc aomorishi.ts && node aomorishi.js | tee aomorishi.log
