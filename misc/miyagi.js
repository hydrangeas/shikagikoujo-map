...
var inputFilePath = 'miyagi-input.csv';
var outputFilePath = 'miyagi.csv';
...
fs.createReadStream(inputFilePath)
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 6:
                _b.sent();
                console.log('miyagi.csv has been written successfully.');
                return [2 /*return*/];
        }
    });
}); });
// npx tsc miyagi.ts && node miyagi.js | tee miyagi.log
