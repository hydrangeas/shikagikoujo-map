...
dotenv.config();
var inputFilePath = 'fukushima-input.csv';
var outputFilePath = 'fukushima.csv';
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                address = "\u798F\u5CF6\u770C".concat(facility.技工所所在地);
            ...
            case 3:
                ...
                for (i = 1; i < data.results.length; i++) {
                    console.log("0 ".concat(facility.歯科技工所名, " (").concat(address, "), ").concat(location_1.lat, ", ").concat(location_1.lng, ",").concat(data.results[0].geometry.location_type));
                    result = data.results[i];
                    console.log("".concat(i, " ").concat(facility.歯科技工所名, " (").concat(address, "), ").concat(result.geometry.location.lat, ", ").concat(result.geometry.location.lng, ", ").concat(result.geometry.location_type));
