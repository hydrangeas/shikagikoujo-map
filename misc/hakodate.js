...
var inputFilePath = 'hakodate-input.csv';
var outputFilePath = 'hakodate.csv';
        ...
        switch (_b.label) {
            ...
            case 3:
                ...
                for (i = 1; i < data.results.length; i++) {
                    console.log("0 ".concat(facility.施設名, " (").concat(facility.所在地, "), ").concat(location_1.lat, ", ").concat(location_1.lng, ", ").concat(data.results[0].geometry.location_type));
                    result = data.results[i];
                    console.log("".concat(i, " ").concat(facility.施設名, " (").concat(facility.所在地, "), ").concat(result.geometry.location.lat, ", ").concat(result.geometry.location.lng, ", ").concat(result.geometry.location_type));
