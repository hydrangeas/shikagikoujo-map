...
fs.createReadStream(inputFilePath)
    ...
    var outputFacilities, i, _i, facilities_1, facility, address, response, data, location_1, i_1, result, csvWriter;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                address = "".concat(facility.施設_所在地);
            ...
            case 3:
                ...
                for (i_1 = 1; i_1 < data.results.length; i_1++) {
                    console.log("0 ".concat(facility.施設_名称, " (").concat(address, "), ").concat(location_1.lat, ", ").concat(location_1.lng, ",").concat(data.results[0].geometry.location_type));
                    result = data.results[i_1];
                    console.log("".concat(i_1, " ").concat(facility.施設_名称, " (").concat(address, "), ").concat(result.geometry.location.lat, ", ").concat(result.geometry.location.lng, ", ").concat(result.geometry.location_type));
