...
var inputFilePath = 'aomoriken-input.csv';
var outputFilePath = 'aomoriken.csv';
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                address = "\u9752\u68EE\u770C".concat(facility.市町村名).concat(facility.所在地);
                return [4 /*yield*/, fetch("".concat(apiUrl, "?key=").concat(apiKey, "&address=").concat(encodeURIComponent("\u3012".concat(facility.郵便番号, " ").concat(address))))];
            case 2:
                response = _b.sent();
