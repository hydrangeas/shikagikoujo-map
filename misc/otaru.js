...
var inputFilePath = 'otaru-input.csv';
var outputFilePath = 'otaru.csv';
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                address = "".concat(facility.所在地);
                return [4 /*yield*/, fetch("".concat(apiUrl, "?key=").concat(apiKey, "&address=").concat(encodeURIComponent("".concat(facility.所在地))))];
            case 2:
                response = _b.sent();
            ...
            case 3:
                ...
                for (i = 1; i < data.results.length; i++) {
                    console.log("0 ".concat(facility.届出歯科技工所名, " (").concat(facility.所在地, "), ").concat(location_1.lat, ", ").concat(location_1.lng, ", ").concat(data.results[0].geometry.location_type));
                    result = data.results[i];
                    console.log("".concat(i, " ").concat(facility.届出歯科技工所名, " (").concat(facility.所在地, "), ").concat(result.geometry.location.lat, ", ").concat(result.geometry.location.lng, ", ").concat(result.geometry.location_type));
