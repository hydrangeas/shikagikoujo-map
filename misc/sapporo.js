...
var inputFilePath = 'sapporo-input.csv';
var outputFilePath = 'sapporo.csv';
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                address = "".concat(facility.施設所在地, " ").concat(facility.施設ビル名);
                return [4 /*yield*/, fetch("".concat(apiUrl, "?key=").concat(apiKey, "&address=").concat(encodeURIComponent("".concat(facility.施設所在地))))];
            case 2:
                response = _b.sent();
